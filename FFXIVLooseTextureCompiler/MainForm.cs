  ...
  ""ModTags"": []
        ...
        public string GetFaceMaterialPath(int material) {
            if (material != 3) {
                ...
                if (selectedText.ToLower() == "the lost" || selectedText.ToLower() == "highlander" || selectedText.ToLower() == "duskwight" || selectedText.ToLower() == "keeper" || selectedText.ToLower() == "dunesfolk" || (selectedText.ToLower() == "veena" && facePart.SelectedIndex == 1)) {
                    faceIdCheck = "010";
                }
