    ...
    public class XNormal {
        ...
        public void AddToBatch(string internalPath, string inputPath, string outputPath, bool isNormalMap) {
            if (File.Exists(inputPath)) {
                if (internalPath.Contains("bibo")) {
                    if (outputPath.Contains("gen2")) {
                        biboToGen2Batch.Add(new XNormalExportJob(internalPath, inputPath, outputPath, biboLegacy, gen2, count++ + ".xml", isNormalMap));
                    } else if (outputPath.Contains("gen3")) {
                        biboToGen3Batch.Add(new XNormalExportJob(internalPath, inputPath, outputPath, bibo, gen3, count++ + ".xml", isNormalMap));
                    }
                } else if (internalPath.Contains("eve") || internalPath.Contains("gen3")) {
                    if (outputPath.Contains("gen2")) {
                        gen3ToGen2Batch.Add(new XNormalExportJob(internalPath, inputPath, outputPath, gen3Legacy, gen2, count++ + ".xml", isNormalMap));
                    } else if (outputPath.Contains("bibo")) {
                        gen3ToBiboBatch.Add(new XNormalExportJob(internalPath, inputPath, outputPath, gen3, bibo, count++ + ".xml", isNormalMap));
                    }
                } else if (internalPath.Contains("body")) {
                    if (outputPath.Contains("bibo")) {
                        gen2ToBiboBatch.Add(new XNormalExportJob(internalPath, inputPath, outputPath, gen2, biboLegacy, count++ + ".xml", isNormalMap));
                    } else if (outputPath.Contains($"gen3")) {
                        gen2ToGen3Batch.Add(new XNormalExportJob(internalPath, inputPath, outputPath, gen2, gen3Legacy, count++ + ".xml", isNormalMap));
                    } else if (internalPath.Contains("--c1101b0001")) {
                        if (outputPath.Contains("otopop")) {
                            vanillaLalaToOtopopBatch.Add(new XNormalExportJob(internalPath, inputPath, outputPath, vanillaLala, otopop, count++ + ".xml", isNormalMap));
                        } else if (outputPath.Contains("asym_lala")) {
                            vanillaLalaToAsymLalaBatch.Add(new XNormalExportJob(internalPath, inputPath, outputPath, vanillaLala, asymLala, count++ + ".xml", isNormalMap));
                        }
                    } else if (internalPath.Contains("v01_c1101b0001_g")) {
                        if (outputPath.Contains("vanilla_lala")) {
                            otopopToVanillaLalaBatch.Add(new XNormalExportJob(internalPath, inputPath, outputPath, otopop, vanillaLala, count++ + ".xml", isNormalMap));
                        } else if (outputPath.Contains("asym_lala")) {
                            otopopToAsymLalaBatch.Add(new XNormalExportJob(internalPath, inputPath, outputPath, otopop, asymLala, count++ + ".xml", isNormalMap));
                        }
                    } else if (internalPath.Contains("v01_c1101b0001_b")) {
                        if (outputPath.Contains("vanilla_lala")) {
                            asymLalaToVanillaLalaBatch.Add(new XNormalExportJob(internalPath, inputPath, outputPath, asymLala, vanillaLala, count++ + ".xml", isNormalMap));
                        } else if (outputPath.Contains("otopop")) {
                            asymLalaToOtopopBatch.Add(new XNormalExportJob(internalPath, inputPath, outputPath, asymLala, otopop, count++ + ".xml", isNormalMap));
                        }
                    }
                }
            } else {
